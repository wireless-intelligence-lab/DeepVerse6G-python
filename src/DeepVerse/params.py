...
def default_params():
    params = {c.PARAMSET_DATASET_FOLDER: './Raytracing_scenarios',
              ...
              c.PARAMSET_RADAR: {
                       ...
                       c.PARAMSET_ANT_TX: {
                          c.PARAMSET_ANT_SHAPE: np.array([1, 1, 4]), # Antenna dimensions in X - Y - Z
                       ...
                       c.PARAMSET_ANT_RX: {
                          c.PARAMSET_ANT_SHAPE: np.array([1, 1, 2]), # Antenna dimensions in X - Y - Z
                          c.PARAMSET_ANT_SPACING: 0.5,
                          #c.PARAMSET_ANT_ROTATION: np.array([0, 0, 0]), # Rotation around X - Y - Z axes
                          c.PARAMSET_ANT_RAD_PAT: c.PARAMSET_ANT_RAD_PAT_VALS[0] # 'omni-directional'
                       },
                       ...
                       c.PARAMSET_CHIRP: {
                            PARAMSET_CHIRP_FS: 15e6,
                            PARAMSET_CHIRP_S: 15e12,
                            PARAMSET_CHIRP_NS = 512,
                            PARAMSET_CHIRP_NC = 128
                       }
              },
              c.PARAMSET_COMM: {          
                      c.PARAMSET_ACTIVE = True,
