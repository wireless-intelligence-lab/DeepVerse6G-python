...
PARAMSET_COMM = 'comm'
PARAMSET_ACTIVE = 'active'

# RADAR PARAMETERS
PARAMSET_RADAR = 'radar'
PARAMSET_ANT_TX = 'tx_antenna'
PARAMSET_ANT_RX = 'rx_antenna'
PARAMSET_CHIRP = 'chirp'
PARAMSET_CHIRP_FS = 'sampling_rate'
PARAMSET_CHIRP_S = 'slope'
PARAMSET_CHIRP_NS = 'num_samples'
PARAMSET_CHIRP_NC = 'num_chirps'

PARAMSET_CAMERA = 'cam'
PARAMSET_LIDAR = 'lidar'
PARAMSET_POSITION = 'loc'
PARAMSET_IDX = 'index'
...
PARAMSET_DYNAMIC = 'scenes'

PARAMSET_NUM_PATHS = 'num_paths'
PARAMSET_ACTIVE_BS = 'BS'
...
OUT_PATH_DOPPLER_VEL = 'Doppler_vel'
OUT_PATH_DOPPLER_ACC = 'Doppler_acc'
